 ...
 */
final class Version20231211095807 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE registration (id INT AUTO_INCREMENT NOT NULL, workshop_id INT NOT NULL, user_id INT NOT NULL, firstname VARCHAR(120) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, lastname VARCHAR(120) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, registration_date DATETIME NOT NULL, INDEX IDX_62A8A7A71FDCE57C (workshop_id), INDEX IDX_62A8A7A7A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('ALTER TABLE registration ADD CONSTRAINT FK_62A8A7A71FDCE57C FOREIGN KEY (workshop_id) REFERENCES workshop (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
